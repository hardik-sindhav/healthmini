  ...
  Widget build(BuildContext context) {
    ...
    return GridView.count(
      ...
      children: [
        ...
        Consumer<ExerciseListProvider>(builder: (context, value, child) {
...
class ButtonCard extends StatelessWidget {
  const ButtonCard({
    ...
    this.iconData,
    this.isCard,
    this.hideTitle, this.btnText, this.onTab,
  });
        ...
        child: Stack(
          ...
          children: [
            Positioned(
              bottom: 10,
              left: 15,
              child: SvgPicture.asset(imageUrl??'assets/svg/health_icon.svg', height: size / 12),
            ),
            Positioned(
              top: 25,
              right: 15,
