...
import 'package:healthmini/screens/details_screen/view/details_mobile_view.dart';
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(body: Consumer<SymptomsListProvider>(
        builder: (context, detailsProvider, child) {
      return Padding(
        padding: const EdgeInsets.symmetric(horizontal: 20),
        child: detailsProvider.findSymptomsState == FindSymptomsState.loading
            ? Center(
            ...
            : detailsProvider.detailsList.isNotEmpty
                ...
                :
                     Center(
                         ...
                         children: [
                           Text(
                         detailsProvider.message !=  '' ? detailsProvider.message : "No Details Found ! \nPlease Visit you near hospital.",
